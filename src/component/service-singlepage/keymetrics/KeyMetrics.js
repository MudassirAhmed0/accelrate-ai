  ...
  return (
    <section className="bg-black text-white py1 poppins">
      ...
      <div className="myContainer">
        ...
        <div className="lg:mt-[4.16666666667vw] mt-[40px] flex lg:flex-row flex-col-reverse flex-wrap lg:flex-nowrap lg:gap-[5.20833333333vw] gap-[20px] justify-between">
          <div className="relative aspect-[1/1.23] w-full lg:w-[32.621%] lg:min-w-[32.621%] hidden lg:block">
