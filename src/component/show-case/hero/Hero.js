  ...
  return (
    <section className="lg:pt-[11.4583333333vw] !pb-[unset] sm:py-[180px] py-[120px] bg-black text-white">
      <div className="myContainer">
        ...
        >
          We help businesses scale with AI-powered conversations, automation, and next-gen digital experiences.
        </h1>
        <div
          data-aos="fade"
        ...
        >
          <p className="lg:text20 mtext18 opacity-[0.7]">
           Discover how our AI and automation solutions have helped businesses scale efficiently <br/> through our case studies —  optimizing customer interactions, streamlining backend workflows, and driving operational excellence.
          </p>
