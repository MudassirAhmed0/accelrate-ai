  ...
  return (
    <>
      <div
        ...
        className="group cursor-pointer text-white testimonialCard relative min-h-full w-[300px] min-w-[300px] sm:w-[350px] sm:min-w-[350px] lg:w-[15.625vw] lg:min-w-[15.625vw] rounded-[20px] text-light p-[1.5625vw] whitespace-normal overflow-hidden"
      >
