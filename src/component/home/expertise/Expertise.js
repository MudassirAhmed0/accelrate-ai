...
const Expertise = ({ variant }) => {
  return (
    ...
    >
      ...
      <div className="mt-[6.25vw] flex flex-col gap-y-[1.25vw]">
        {expertises.map((expertise, index) => (
          <Marquee
            ...
            className="flex"
          >
            {expertise.slider.map((slide, index) => (
              <div
                data-aos="fade"
                key={index}
                className="bg-black text-white rounded-[20px] p-[3.125vw] ml-[1.25vw]"
              >
                <h4 className="text30 font-medium text-center">
                  {slide.title}
                </h4>
                <div className="flex whitespace-nowrap justify-center gap-y-[2.5vw] gap-x-[6.25vw] mt-[2.86458333333vw]">
                  {slide.logos.map((logo, ind) => (
                    <div
                      data-aos="fade"
                      ...
                      className={`relative lg:min-w-[7.8125vw] lg:size-[7.8125vw] animate-bounce`}
                    >
                      <Image
                        fill
                        alt="expertiseLogo"
