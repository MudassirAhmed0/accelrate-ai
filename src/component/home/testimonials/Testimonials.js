...
const Testimonials = () => {
  useGSAP(() => {
    const totalWidth = document.querySelector(".cardsWrapper").offsetWidth;
    // Animate the cards-section on scroll
    gsap.to(".cardsWrapper", {
      x: () => `-${totalWidth}px`, // Translate the cards-section completely out of view
      scrollTrigger: {
  ...
  return (
    <section className="fullVh fullSvh h-[100vh] w-full bg-secondary-light flex items-center overflow-hidden relative testimonialsSection">
      ...
      <div className="min-w-[50%] w-auto absolute top-0 left-[50%] translate-x-0 flex items-center bg-primary-blue h-full cardsWrapper px-[120px]">
