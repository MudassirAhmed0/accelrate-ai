...
const Stats = () => {
  return (
    <section className="py1 lg:pb-[7.8125vw] relative bg-black">
      <div className="relative z-[2] myContainer flex flex-col items-center lg:gap-y-[5.20833333333vw] gap-y-[62px] text-white">
